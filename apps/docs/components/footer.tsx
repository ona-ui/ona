          ...
          >
            ...
            >
              <div className="mb-6">
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-[#C96342] to-[#B55638] hover:from-[#B55638] hover:to-[#A14D2F] text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 mb-4"
            ...
            >
              ...
              <ul className="space-y-3">
                {[
                  { name: 'Browse Components', href: '/docs/blocks', available: true },
